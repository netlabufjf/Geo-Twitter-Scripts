...
arquivo = open("{}/amizade.id_users.list.csv".format(dir_cidade), "r")
for line in arquivo.readlines():

    arquivo_no = '{}/data/{}/user_timeline/{}.json.gz'.format(dir_base, cidade_param, line.rstrip())

    try:
        lista_count_tweets.append(len(extract_list_geo(arquivo_no)))
    except Exception:
        add_lista("count_tweets_error", line.rstrip(), cidade_param)
...
arquivo_saida = '{}/data/{}/CDF_num_tweets_amigos.png'.format(dir_base, cidade_param)
